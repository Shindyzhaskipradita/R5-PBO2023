...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Dari Bahasa:').grid(row=1, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Ke Bahasa:').grid(row=5, column=0,
            sticky=W, padx=5, pady=5)


        # Pasang Textbox
        self.txtSumber = Entry(mainFrame, width=80) 
        self.txtSumber.grid(row=0, column=1, padx=5, pady=5)

        self.txtHasil = Entry(mainFrame, width=80) 
        self.txtHasil.grid(row=2, column=1, padx=5, pady=5)

        # Pasang Combobox (Dropdown) untuk Bahasa Masukan
        self.from_lang_combobox = ttk.Combobox(mainFrame, values=["id", "en", 'jw', 'ar', 'zh-cn','ms',])
        ...
        self.to_lang_combobox = ttk.Combobox(mainFrame, values=['id', 'en', 'jw', 'ar', 'zh-cn','ms',])
        self.to_lang_combobox.grid(row=5, column=1, padx=5, pady=5)
        self.to_lang_combobox.set("en")

        # Pasang Button
        self.btnTranslate = Button(mainFrame, text='Translate!', command=self.onTranslate)
        self.btnTranslate.grid(row=6, column=1, padx=5, pady=5) 
